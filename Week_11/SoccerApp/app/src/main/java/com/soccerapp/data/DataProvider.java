...
/**
 * DataProvider creates hardcoded sample data for the application and
 * populates the generic repositories.
 *
 * <p>This class is deliberately non-generic: it knows about the concrete
 * entity types, which keeps the repository classes clean and reusable.</p>
 */
